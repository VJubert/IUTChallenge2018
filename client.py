...
class ClientConcoursProg(asyncio.Protocol):
    ...
    def traite_donnees(self, donnees):
        self.send_message(self.game.play(donnees))
        # # print("         NEW TURN            ")
        # # print(self.joueurs)
        ...
        #             if cost < coming:
        #                 # retourne et tire
        #                 rotate = rotate_to(cast_rot_inverse(joueur.direction),
        #                                    rotation_requise(joueur.current_pos(), pos))
        #
        #                 print("rotate", rotate)
        #                 if cost < 2:
        #                     self.send_message([rotate, "shoot"])
        #                 else:
        #                     self.send_message([rotate])
        #                 return
        #
        ...
        #     if len(path) > 0:
        #         print(path)
        #         shoot = self.map.get_at(*path[0]).est_mur_traversable()
